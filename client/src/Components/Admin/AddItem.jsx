    ...
    const addDesign = async (name, description, price, category) => {
        try {
            const newDesign = {
                ...
                image_url: imagePath // כאן שולחים את הנתיב לשרת
            };
        ...
        <>
            <Card title="הוספת עיצוב חדש">
                <div className="card flex flex-column gap-4">
                    ...
                    <div className="flex flex-column gap-2">
                        <label htmlFor="image">בחרי תמונה:</label>
                        <input
                            type="file"
                            accept="image/*"
                            onChange={(e) => {
                                ...
                                if (file) {
                                    ...
                                    const relativePath = `/${fileName}`; // מתוך תקיית public
                                    setImagePath(relativePath);
                                }
                            }}
                        />
                        {imagePath && (
                            <img src={imagePath} alt="תצוגה מקדימה" style={{ width: 150, marginTop: 10 }} />
                        )}
                    </div>
